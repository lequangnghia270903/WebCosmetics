<!DOCTYPE html>
<head>
<title>Trang quản lý web dành cho Admin</title>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/avt.gif')}}">
                <span class="username">
                    <?php
 ...
 <!-- footer -->
          <div class="footer">
            <div class="wthree-copyright">
              <p>©2022 Visitors. All rights reserved | Design by <a href="">SHOP MỸ PHẨM</a> </p>
            </div>
          </div>
  <!-- / footer -->
</section>
